...
{
    return QCoreApplication::translate("qstees-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. qstees_de.qm (shortcut "de" needs to be defined in qstees.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. qstees_de_DE.qm (shortcut "de_DE" needs to be defined in qstees.qrc)
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // qstees: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(qstees);
    Q_INIT_RESOURCE(qstees_locale);
    ...
    /// 6. Determine availability of data and blocks directory and parse qstees.conf
    ...
    // qstees: links repeatedly have their payment requests routed to this process:
