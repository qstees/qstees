...
Note that for WSL the QSTEES Core source path MUST be somewhere in the default mount file system, for
...
way. This will install to `c:\workspace\QSTEES-core`, for example:

    make install DESTDIR=/mnt/c/workspace/QSTEES-core
...
modifying headers in the QSTEES Core source code).
